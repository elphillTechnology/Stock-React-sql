                                    ...
                                    <div className="">
                                        <div className="row">
                                            <div className="col-md-4 mb-3">
                                                <label htmlFor="strategy_name" className="form-label">Strategy Name</label>
                                                <input type="text" className="form-control" id="strategy_name" placeholder='Strategy Name' />
                                            </div>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-3 mb-3">
                                                        ...
                                                        <select className="form-select" aria-label="Default select example" >
                                                            ...
                                                            <option value={"2"}>Entry By ATM Percent</option>
                                                            <option value={"3"}>Entry By Closer Premium</option>
                                                            <option value={"4"}>CP Strick Based On Sp</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-2 mb-3">
                                                        ...
                                                        <select className="form-select mb-0" id="gender" aria-label="Gender select example">
                                                            ...
                                                            <option value="2">All Leg's</option>
                                                        </select>
                                                    </div>
                                                    <div className="col-md-4">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-2 mb-3">
                                                        ...
                                                        <select className="form-select" id='re_entry_mode' aria-label="Default select example">
                                                            ...
                                                            <option value="NIFTY">Re-execute</option>
                                                            <option value="NIFTY">Re-execute@cost</option>
                                                        </select>
                                                    </div>
                                                    <div className="col-md-2 mb-3">
                                                    ...
                                                    <div className="col-md-2 mb-3">
                                                        ...
                                                        <select className="form-select" id='time_frame' aria-label="Default select example">
                                                            ...
                                                            <option value="NIFTY">3 minute</option>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-2 mb-3">
                                                            <input className="form-check-input" type="checkbox" id="special_day" />
                                                            <label className="form-check-label" htmlFor="special_day">Special Day</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </>
