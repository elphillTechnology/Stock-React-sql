                                    ...
                                    <div className="col-12 col-xxl-6 pe-xxl-0">
                                        ...
                                        <div className="small d-flex mt-1">
                                            <div>
                                                ...
                                                <span className="text-success fw-bolder">18,2%</span> Since last month
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-12 col-xxl-6 ps-xxl-4 pe-xl-0">
                                        ...
                                        <div className="small d-flex mt-1">
                                            <div>
                                                ...
                                                <span className="text-danger fw-bolder">4,6%</span> Since last month
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-12 col-sm-6 col-xl-12 col-xxl-6 ps-xxl-4 pe-xxl-0">
                                        ...
                                        <div className="small d-flex mt-1">
                                            <div>
                                                ...
                                                <span className="text-success fw-bolder">20%</span> Since last month
                                            </div>
                                        </div>
                                    </div>
                                </div>
